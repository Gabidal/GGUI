...
GGUI::List_View::List_View(Styling css, unsigned int width, unsigned int height, Element* parent, IVector3 position) : Element(css){
...
GGUI::Scroll_View::Scroll_View(Styling css, unsigned int width, unsigned int height, Element* parent, IVector3 position) : Element(css){
